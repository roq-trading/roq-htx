...
#include "roq/htx/proto_bridge/application.hpp"
...
auto const INFO = roq::Service::Info{
    .description = "Roq's HTX gateway (Protobuf interface)"sv,
...
int main(int argc, char **argv) {
  ...
  return roq::htx::proto_bridge::Application{args, settings, INFO}.run();
}
