...
Rest::Rest(Handler &handler, io::Context &context, uint16_t stream_id, Shared &shared)
    : handler_{handler}, stream_id_{stream_id}, name_{create_name(stream_id_)}, connection_{create_connection(*this, shared.settings, context)},
      ...
      profile_{
          .market_status = create_metrics(shared.settings, name_, "market_status"sv),
          .market_status_ack = create_metrics(shared.settings, name_, "market_status_ack"sv),
          ...
          .symbols = create_metrics(shared.settings, name_, "symbols"sv),
          .symbols_ack = create_metrics(shared.settings, name_, "symbols_ack"sv),
      },
      latency_{
